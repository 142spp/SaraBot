...
SYSTEM_PROMPT = (
    ...
    "  별도의 하단 '근거' 섹션으로 몰아넣지 말고, 관련 설명 바로 옆에 placeholder를 붙여.\n"
    "  예: '아쎄이가 그때 뉴진스를 언급한 기록이 있어 {{E1}}.'\n"
    "  실제 시간·작성자·원문 링크·짧은 인용은 시스템이 placeholder를 치환해서 넣는다.\n"
    ...
    "  별도의 하단 '출처' 섹션으로 몰아넣지 말고, 관련 설명 바로 옆에 placeholder를 붙여.\n"
    "  날씨·시세·단순 최신 정보처럼 짧은 답변은 보통 가장 관련 높은 {{E1}} 하나만 붙여.\n"
    "  사용자가 여러 출처를 요구했거나 쟁점이 갈리는 정보일 때만 {{E2}}, {{E3}}까지 써.\n"
    "  실제 제목·URL·발행일은 시스템이 placeholder를 치환해서 넣는다.\n"
