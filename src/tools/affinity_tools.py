        ...
        return {
            ...
            "function": {
                ...
                "description": (
                    ...
                    "사소한 건 건드리지 말고 의미 있는 순간에만 쓰되, "
                    "강한 사건이면 +5 초과나 -5 미만도 적극적으로 써. "
                    "기준: 가벼움 ±1, 평범한 감사·무례 ±2~3, "
                    "확실한 애정·반복 도발 ±4~6, 큰 도움·심한 모욕 ±7~10. "
                ...
                "parameters": {
                    ...
                    "properties": {
                        "delta": {
                            "type": "integer",
                            "description": (
                                "변화량 (-10~+10). 양수=호감 상승, 음수=하락. "
                                "큰 사건이면 +7~+10 또는 -7~-10도 사용."
                            ),
                        },
                        "reason": {
                            "type": "string",
